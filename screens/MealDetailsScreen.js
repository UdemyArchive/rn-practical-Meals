...
const MealDetailsScreen = props => {
  const availableMeals = useSelector(state => state.meals.meals); //filteredMeals
  ...
  //use useCallback to avoid infinite loop on change
  ...
  //useEffect runs after render, so title pops
  /*useEffect(() => {
